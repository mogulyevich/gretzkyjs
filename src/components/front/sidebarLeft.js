...
import * as containerStyles from "./sidebarLeft.module.css"
...
const SidebarLeftConstruct = ({ data }) => {
    ...
    return (
        <div className={containerStyles.left}>
            ...
            <div className={containerStyles.adSpace}>
                <h5>This Is An Ad</h5>
                <p>Tagline for your Ad</p>
            </div>
            <div className={containerStyles.sidePostLeft}>
...
export default function SidebarLeft(props) {
    return (
        <StaticQuery 
            ...
            render = {data => <SidebarLeftConstruct data={data} {...[props]} />}
        />
    )
}